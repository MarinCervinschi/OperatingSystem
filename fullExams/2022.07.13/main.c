...
int main(int argc, char const **argv) {
    ...
    int Q;                  /* numero processi figli */
    /* ATTENZIONE 'Q' variabile del testo */
    ...
    /* ATTENZIONE 'L' variabile del testo */
    ...
    for (q = 3; q < argc - 1; q++) {
        /* controllo che il q-esimo parametro sia un singolo carattere */
        if (argv[q][1] != '\0') {
    ...
    /* Salvo il numero dei processi in una variabile */
    Q = argc - 3; 
